    ...
    return (
        <article className="stats-card">
            ...
            <div className="content">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <figure className="flex items-center gap-1">
                            ...
                            alt="arrow"
                            />
                            <figcaption className={cn('text-sm font-medium',isDecrement ? 'text-red-500':'text-succes-700')}>
                ...
                <img src={`/assets/icons/${isDecrement ? 'decrement.svg': 'increment.svg'}`}  className="xl:w-32 w-full md:h-32 xl:h-full " alt={""}/>
                </div>
        </article>
